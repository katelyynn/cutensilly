                    ...
                    <tbody>
                        <tr>
                            <th>
                                ...
                                <p className="explain">a cute heart badge to represent your kindness</p>
                            </th>
                            <td>
                                <IconCheck className="table-y" />
                            </td>
                            <td>
                                <IconCheck className="table-y" />
                            </td>
                        ...
                        <tr>
                            <th>
                                ...
                                <p className="explain">an icon from <a href="https://tabler.io/icons" target="_blank">tabler</a> or <a href="https://lucide.dev" target="_blank">lucide</a>, as long as it doesnt copy a last.fm or bleh badge. <b>any text of your choosing</b> as long as its not nsfw or hateful.</p>
                            </th>
                            <td>
                                <IconX className="table-x" />
                            </td>
                            <td>
                                <IconCheck className="table-y" />
                            </td>
                        ...
                        <tr>
                            <th>
                                ...
                                <p className="explain">the three <b>hue, sat, lit</b> sliders in bleh, passed alongside your badge request.</p>
                            </th>
                            <td>
                                <IconX className="table-x" />
                            </td>
